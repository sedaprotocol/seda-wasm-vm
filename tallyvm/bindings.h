...
struct FfiVmResult execute_tally_vm(const uint8_t *wasm_bytes,
                                    ...
                                    const uint8_t *const *args_ptr,
                                    const uintptr_t *args_len,
                                    uintptr_t args_count,
                                    const uint8_t *const *env_keys_ptr,
                                    const uintptr_t *env_keys_len,
                                    const uint8_t *const *env_values_ptr,
                                    const uintptr_t *env_values_len,
                                    uintptr_t env_count);
